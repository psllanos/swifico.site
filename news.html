                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts">
                        <div class="single-blog-post">
                            <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/blog/b1.jpg')"></div>
                        ...
                        <div class="single-blog-post">
                            <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/blog/b2.jpg')"></div>
                            <div class="post-content">
                                <h2><a href="news-details.html">Adobe XD Contest: Create An App Prototype With Your City’s Best-Kept Secrets</a></h2>
                                <div class="post-meta">
                                    <span><i class="fal fa-eye"></i>232 Views</span>
                                    <span><i class="fal fa-comments"></i>35 Comments</span>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-30">
                                    <div class="author-info">
                                        ...
                                        <h5><a href="#">by Michael K. Steven</a></h5>
                                    </div>
                                    <div class="post-link">
                                        <a href="news-details.html"><i class="fal fa-arrow-right"></i> Read More</a>
                                    </div>
                        ...
                        <div class="single-blog-post">
                            <div class="post-featured-thumb bg-cover" style="background-image: url('assets/img/blog/b4.jpg')"></div>
                            <div class="post-content">
                                <h2><a href="news-details.html">Designing For User Interfaces Icons As Visual Elements For Screen Design</a></h2>
                                <div class="post-meta">
                                    <span><i class="fal fa-eye"></i>232 Views</span>
                                    <span><i class="fal fa-comments"></i>35 Comments</span>
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-sidebar-widget instagram-widget">
                            ...
                            <div class="instagram-gallery">
                                ...
                                <a href="assets/img/blog/ip7.jpg" class="single-photo-item bg-cover popup-gallery" style="background-image: url('assets/img/blog/ip7.jpg')">                                    
                                </a>
                            </div>
                        </div>
                        <div class="single-sidebar-widget">
